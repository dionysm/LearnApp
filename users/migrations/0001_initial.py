    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abzeichen', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.abzeichen')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='abzeichen', to=settings.AUTH_USER_MODEL)),
            ],
            options={
